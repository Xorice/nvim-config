...
-- 注释
-------------------------------------------------------------------------------
key('n', '<C-_>',  'gcc', { remap = true, silent = true, desc = '󰆉 Toggle Comment' })
key('v', '<C-_>',  'gc gv',  { remap = true, silent = true, desc = '󰆉 Toggle Comment' })
-------------------------------------------------------------------------------
-- 按单词跳转
-------------------------------------------------------------------------------
...
-- 编译运行 
-------------------------------------------------------------------------------
key('n', '<leader>rc', function() require('compile').run() end, { desc = '󰑮 Compile & Run' })
